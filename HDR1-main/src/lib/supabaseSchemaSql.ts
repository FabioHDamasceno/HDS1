export const SUPABASE_FULL_SCHEMA_SQL = `-- Schema SQL para a base de dados Supabase da OficinaAuto PT
...
-- Criar políticas de permissão pública para acesso completo da App
